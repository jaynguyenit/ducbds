                ...
                <div class="py-4">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            ?>
                                <div class="relative group skeleton-loading">
                            ...
                            <div class="relative custom-price-dropdown skeleton-loading" id="price-dropdown-compact">
    ...
    <?php else : ?>
        ...
        <div class="space-y-4 md:space-y-6">
            ...
            <div class="<?php echo $is_sidebar ? 'space-y-4' : 'grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4'; ?>">
                <div class="relative group col-span-2 md:col-span-1 skeleton-loading">
                ...
                <div class="relative group custom-price-dropdown col-span-1 skeleton-loading" id="price-dropdown-home">
